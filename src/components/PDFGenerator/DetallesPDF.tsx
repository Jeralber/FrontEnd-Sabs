...
import { FaUser, FaUserCog, FaUserCheck, FaUserEdit } from "react-icons/fa";
...
const DetallesPDF: React.FC<DetallesPDFProps> = ({ data, startDate, endDate, reportType = "normal" }) => {
  ...
  const normalColumns = [
    ...
    { header: 'Solicitante', accessor: 'personasolicitaRelation.nombre', width: '20%' },
    { header: 'Encargado', accessor: 'personaencargadaRelation.nombre', width: '20%' },
    { header: 'Aprobador', accessor: 'personaapruebaRelation.nombre', width: '20%' },
  ];
