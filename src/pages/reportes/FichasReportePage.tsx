...
import FichaReportSelector from '../../components/PDFGenerator/FichaReportSelector';
...
const FichasReportePage: React.FC = () => {
  ...
  const [filteredFichas, setFilteredFichas] = useState<Partial<Ficha>[]>([]);
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Reporte de Fichas</h1>
        <button
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredFichas.map((ficha) => (
                  <tr key={ficha.idficha}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {ficha.fechaactualización ? new Date(ficha.fechaactualización).toLocaleDateString('es-ES') : '-'}
                    </td>
                  </tr>
                ))}
              </tbody>
