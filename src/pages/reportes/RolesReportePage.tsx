...
const RolesReportePage: React.FC = () => {
  ...
  const [filteredRoles, setFilteredRoles] = useState<Partial<Rol>[]>([]);

  // Inicializar filteredRoles con todos los roles cuando se cargan
  React.useEffect(() => {
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredRoles.map((rol) => {
                  const fechaCreacion = rol.fechacreacion ? new Date(rol.fechacreacion) : null;
                  ...
                  return (
                    <tr key={rol.idrol}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {rol.fechaactualización ? new Date(rol.fechaactualización).toLocaleDateString('es-ES') : '-'}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
